<?php
	...
	$url='http://api.geonames.org/postalCodeLookupJSON?formatted=true&postalcode=' . $_REQUEST['postalcode'] . '&username=stuart_xiv&style=full';
	...
	$output['data'] = $decode['postalcodes'];   //// check the api link, first detail that expands (little arrow)
